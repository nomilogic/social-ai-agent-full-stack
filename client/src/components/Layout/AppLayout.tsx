            ...
            return (
              <Link
                ...
                className={`flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-colors ${
                  isActive
                    ? 'theme-bg-primary theme-text-primary border-r-2 border-white'
                    : 'theme-text-secondary hover:theme-bg-primary hover:theme-text-primary'
                }`}
              >
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative" ref={userMenuRef}>
                ...
                >
                  <img
                    className="h-8 w-8 rounded-full object-cover border-2 border-white/30"
                    src={user?.avatar_url || `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.full_name || user?.email || 'User')}&background=3b82f6&color=fff`}
                    alt=""
                  />
                </button>
                {showUserMenu && (
                  <div className="absolute right-0 z-10 mt-2 w-48 theme-bg-card rounded-md shadow-lg py-1 border border-white/20">
                    <div className="px-4 py-2 text-sm border-b border-white/20">
                      <div className="font-medium theme-text-primary">{user?.full_name || 'User'}</div>
                      <div className="theme-text-light">{user?.email}</div>
                    </div>
                    <Link
                      to="/settings"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center">
              ...
              <div className="mt-4 flex justify-center space-x-6 text-sm theme-text-secondary">
                <a href="#" className="hover:theme-text-primary transition-colors duration-200">Privacy Policy</a>
                <a href="#" className="hover:theme-text-primary transition-colors duration-200">Terms of Service</a>
                <a href="#" className="hover:theme-text-primary transition-colors duration-200">Support</a>
              </div>
            </div>
          </div>
        </footer>
